...
public final class ActivityMain2Binding implements ViewBinding {
  ...
  @NonNull
  public final TextView mEdtTitle;

  @NonNull
  public final TextView textView;

  private ActivityMain2Binding(@NonNull ConstraintLayout rootView, @NonNull Button mBtnStart,
      @NonNull TextView mEdtTitle, @NonNull TextView textView) {
    this.rootView = rootView;
    this.mBtnStart = mBtnStart;
    this.mEdtTitle = mEdtTitle;
  ...
  public static ActivityMain2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.mEdtTitle;
      TextView mEdtTitle = ViewBindings.findChildViewById(rootView, id);
      if (mEdtTitle == null) {
        break missingId;
      }
      ...
      return new ActivityMain2Binding((ConstraintLayout) rootView, mBtnStart, mEdtTitle, textView);
    }
